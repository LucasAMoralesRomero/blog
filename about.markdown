...
¡Hola! Soy Lucas, un desarrollador en continua formación, especializado mayormente en C++ y adentrándome en C#, .NET y tecnologias web.
Actualmente, estoy cursando la carrera de Diseño y Programación de Videojuegos y Simuladores en la Universidad Nacional del Litoral (UNL).
